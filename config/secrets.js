...
module.exports = {
  ...
  sendgrid: {
    user: process.env.SENDGRID_USER || 'Aradalf',
    password: process.env.SENDGRID_PASSWORD || 'jpshackers'
  },
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '706135762788359',
    clientSecret: process.env.FACEBOOK_SECRET || '052bf2fb925c1391c61afb57d495f23e',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '404462300583-o4k0e1pj8985ln3nh71kgbi80lingg5a.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || '404462300583-o4k0e1pj8985ln3nh71kgbi80lingg5a@developer.gserviceaccount.com ',
